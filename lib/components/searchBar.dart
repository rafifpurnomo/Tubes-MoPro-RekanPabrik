    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Display search results or default companies
          Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Container(
                  margin:
                      EdgeInsets.symmetric(vertical: 5), // Space between items
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              detailPerusahaan(companyId: results[index].id),
                        ),
                      );
                    },
                    child: ListTile(
                      ...
                      subtitle:
                          Text('${results[index].jumlahLowongan} Lowongan'),
                    ),
                  ),
                );
              },
